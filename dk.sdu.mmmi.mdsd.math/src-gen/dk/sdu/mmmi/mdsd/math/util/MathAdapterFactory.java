...
public class MathAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MathSwitch<Adapter> modelSwitch =
    new MathSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseClass(dk.sdu.mmmi.mdsd.math.Class object)
      {
      ...
      @Override
      public Adapter caseExternalBinding(ExternalBinding object)
      {
        return createExternalBindingAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.DomainModel <em>Domain Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.Class <em>Class</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.ExternalBinding <em>External Binding</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createExternalBindingAdapter()
  {
    return null;
  }
