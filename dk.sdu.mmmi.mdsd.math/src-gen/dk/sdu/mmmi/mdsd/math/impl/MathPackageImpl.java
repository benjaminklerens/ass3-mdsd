...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass externalBindingEClass = null;
   ...
   */
  @Override
  public EReference getClass_Externals()
  {
   ...
   */
  @Override
  public EReference getClass_Math()
  {
   ...
   */
  @Override
  public EClass getExternalBinding()
  {
    return externalBindingEClass;
  }
   ...
   */
  @Override
  public EReference getExternalBinding_Ref()
  {
    return (EReference)externalBindingEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getExternalBinding_Parameters()
  {
    return (EReference)externalBindingEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(domainModelEClass, DOMAIN_MODEL__ELEMENT);

    classEClass = createEClass(CLASS);
    createEAttribute(classEClass, CLASS__NAME);
    createEReference(classEClass, CLASS__EXTERNALS);
    createEReference(classEClass, CLASS__MATH);
    ...
    externalBindingEClass = createEClass(EXTERNAL_BINDING);
    createEReference(externalBindingEClass, EXTERNAL_BINDING__REF);
    createEReference(externalBindingEClass, EXTERNAL_BINDING__PARAMETERS);
  ...
  public void initializePackageContents()
  {
    ...
    externalBindingEClass.getESuperTypes().add(this.getExpression());
    ...
    initEReference(getDomainModel_Element(), this.getClass_(), null, "element", null, 0, 1, DomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(classEClass, dk.sdu.mmmi.mdsd.math.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getClass_Name(), ecorePackage.getEString(), "name", null, 0, 1, dk.sdu.mmmi.mdsd.math.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_Externals(), this.getExternal(), null, "externals", null, 0, -1, dk.sdu.mmmi.mdsd.math.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_Math(), this.getMathExp(), null, "math", null, 0, 1, dk.sdu.mmmi.mdsd.math.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(externalBindingEClass, ExternalBinding.class, "ExternalBinding", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getExternalBinding_Ref(), this.getExternal(), null, "ref", null, 0, 1, ExternalBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getExternalBinding_Parameters(), this.getExpression(), null, "parameters", null, 0, -1, ExternalBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
