...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathPackage.eINSTANCE)
			...
			case MathPackage.CLASS:
				sequence_Class(context, (dk.sdu.mmmi.mdsd.math.Class) semanticObject); 
				return; 
			case MathPackage.DIV:
				sequence_Factor(context, (Div) semanticObject); 
				return; 
			case MathPackage.DOMAIN_MODEL:
			...
			case MathPackage.EXTERNAL_BINDING:
				sequence_ExternalBinding(context, (ExternalBinding) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (name=ID (externals+=External externals+=External*)? math=MathExp?)
	 * </pre>
	 */
	protected void sequence_Class(ISerializationContext context, dk.sdu.mmmi.mdsd.math.Class semanticObject) {
	...
	protected void sequence_DomainModel(ISerializationContext context, DomainModel semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.DOMAIN_MODEL__ELEMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.DOMAIN_MODEL__ELEMENT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDomainModelAccess().getElementClassParserRuleCall_1_0(), semanticObject.getElement());
		feeder.finish();
	}
	 ...
	 * <pre>
	 * Contexts:
	 *     Exp returns ExternalBinding
	 *     Exp.Plus_1_0_0_0 returns ExternalBinding
	 *     Exp.Minus_1_0_1_0 returns ExternalBinding
	 *     Factor returns ExternalBinding
	 *     Factor.Mult_1_0_0_0 returns ExternalBinding
	 *     Factor.Div_1_0_1_0 returns ExternalBinding
	 *     Primary returns ExternalBinding
	 *     ExternalBinding returns ExternalBinding
	 *
	 * Constraint:
	 *     (ref=[External|ID] (parameters+=Exp parameters+=Exp*)?)
	 * </pre>
	 */
	protected void sequence_ExternalBinding(ISerializationContext context, ExternalBinding semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (variables+=VarBinding variables+=VarBinding*)
	 * </pre>
	 */
