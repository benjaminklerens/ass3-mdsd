...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClassAccess().getGroup_2_1_1(), "rule__Class__Group_2_1_1__0");
			...
			builder.put(grammarAccess.getDataTypesAccess().getGroup(), "rule__DataTypes__Group__0");
			builder.put(grammarAccess.getDataTypesAccess().getGroup_1(), "rule__DataTypes__Group_1__0");
			...
			builder.put(grammarAccess.getExternalBindingAccess().getGroup(), "rule__ExternalBinding__Group__0");
			builder.put(grammarAccess.getExternalBindingAccess().getGroup_2(), "rule__ExternalBinding__Group_2__0");
			builder.put(grammarAccess.getExternalBindingAccess().getGroup_2_1(), "rule__ExternalBinding__Group_2_1__0");
			builder.put(grammarAccess.getDomainModelAccess().getElementAssignment_1(), "rule__DomainModel__ElementAssignment_1");
			builder.put(grammarAccess.getClassAccess().getNameAssignment_1(), "rule__Class__NameAssignment_1");
			builder.put(grammarAccess.getClassAccess().getExternalsAssignment_2_1_0(), "rule__Class__ExternalsAssignment_2_1_0");
			builder.put(grammarAccess.getClassAccess().getExternalsAssignment_2_1_1_1(), "rule__Class__ExternalsAssignment_2_1_1_1");
			builder.put(grammarAccess.getClassAccess().getMathAssignment_3_1(), "rule__Class__MathAssignment_3_1");
			...
			builder.put(grammarAccess.getMathExpAccess().getVariablesAssignment_0(), "rule__MathExp__VariablesAssignment_0");
			builder.put(grammarAccess.getMathExpAccess().getVariablesAssignment_1_1(), "rule__MathExp__VariablesAssignment_1_1");
			...
			builder.put(grammarAccess.getExternalBindingAccess().getRefAssignment_0(), "rule__ExternalBinding__RefAssignment_0");
			builder.put(grammarAccess.getExternalBindingAccess().getParametersAssignment_2_0(), "rule__ExternalBinding__ParametersAssignment_2_0");
			builder.put(grammarAccess.getExternalBindingAccess().getParametersAssignment_2_1_1(), "rule__ExternalBinding__ParametersAssignment_2_1_1");
